//
//  PridePaymentViewController.swift
//  Pride
//
//  Created by NonStop io on 06/11/17.
...
class PridePaymentViewController: UIViewController, OrderRequestCallBack, UITextFieldDelegate {
    ...
    override func viewDidLoad() {
        ...
        if (defaults.string(forKey: "userName") != nil){
            ...
            print("\n Mobile No",defaults.string(forKey: "MobileNo")!)
            phoneNumberTextfield.text = defaults.string(forKey: "MobileNo")
            print("\n email Id",defaults.string(forKey: "email")!)
            emailTextField.text = defaults.string(forKey: "email")
            amountTextField.text = "10"
            
            descriptionTextField.text = "Pay For PRIDE Membership Subscription"
        }
...
//                let newViewController = PaymentOptions()
//                Instamojo.invokePaymentOptionsView(order: order, controller: newViewController)
...
//                topWindow.rootViewController?.present(paymentOptions, animated: true, completion: nil)
...
//    func invokePaymentOptionsView(order: Order, controller: UIViewController){
//
//                        let paymentOptions = self.storyboard?.instantiateViewController(withIdentifier: "paymentOptions") as! PaymentOptions
//                        paymentOptions.order = order
//                        self.navigationController?.pushViewController(paymentOptions, animated: true)
